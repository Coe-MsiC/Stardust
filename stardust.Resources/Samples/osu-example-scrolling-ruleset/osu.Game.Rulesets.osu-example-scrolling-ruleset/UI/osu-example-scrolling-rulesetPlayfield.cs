...
{
    [Cached]
    public partial class osu_example_scrolling_rulesetPlayfield : ScrollingPlayfield
    {
        public const float LANE_HEIGHT = 70;

        public const int LANE_COUNT = 6;

        public BindableInt CurrentLane => osu_example_scrolling_ruleset.LanePosition;

        private osu_example_scrolling_rulesetCharacter osu_example_scrolling_ruleset;
            ...
            AddRangeInternal(new Drawable[]
            {
                new LaneContainer
                {
                    ...
                    Child = new Container
                    {
                        ...
                        {
                            HitObjectContainer,
                            osu_example_scrolling_ruleset = new osu_example_scrolling_rulesetCharacter
                            {
